...
class Command(BaseCommand):
    help = "Crawl News18 Tamil - Cinema Category with Load More button handling"
    ...
    async def crawl(self):
        ...
        async with async_playwright() as p:
            ...
            url = "https://tamil.news18.com/entertainment/"
            print(f"\n🌐 Opening {url}")
            ...
            while clicks_done < max_clicks:
                ...
                load_more = await page.query_selector('button.Load_more')  # ✅ Correct for Cinema
                if load_more:
                ...
                try:
                    ...
                    await sync_to_async(NewsDetails.objects.get_or_create)(
                        ...
                        defaults={
                            ...
                            'image_url': image_url,
                            'category': category,
                            'published_time': None,  # No published time available
                            'author': None,
                            'description': None,
                        }
                    )
