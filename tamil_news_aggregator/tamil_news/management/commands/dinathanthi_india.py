...
class Command(BaseCommand):
    help = "Crawl DinaThanthi India News with Pagination (Async + ORM Safe)"
    ...
    def parse_date(self, date_str):
        ...
        try:
            ...
            return pytz.UTC.localize(dt)  # Store as UTC with timezone
        except Exception:
            return None
    ...
    async def crawl(self):
        ...
        async with async_playwright() as p:
            ...
            for page_num in range(1, max_pages + 1):
                page_count += 1
                url = f"https://www.dailythanthi.com/news/india?page={page_num}"
